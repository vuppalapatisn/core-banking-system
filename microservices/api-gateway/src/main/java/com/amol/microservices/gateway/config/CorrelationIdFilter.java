...
/**
 * Establishes the {@code X-Correlation-Id} for every request so a single request's story
 * can be stitched together across services, and puts it on the MDC for structured logs.
 */
@Component
